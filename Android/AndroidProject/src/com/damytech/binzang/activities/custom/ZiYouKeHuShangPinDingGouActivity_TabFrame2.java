 ...
 * Date : 2015-04-21
 * Time : 17:25
 * File Name : DingJinDanChaXunYuanGong_TabFrame2
 */
public class ZiYouKeHuShangPinDingGouActivity_TabFrame2 extends SuperTabActivity.TabFrame {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View contentView = inflater.inflate(R.layout.activity_ziyoukehushangpindinggou_tab2, container, false);
	...
	private void getItemsFromService() {
		...
		CommManager.getBuyProductLogs(AppCommon.loadUserIDLong(parentActivity.getApplicationContext()),
				page_no,
				ConstMgr.BUY_PRODUCT_LOG_TYPE_COMPLETED,
				list_delegate);
	}
	...
	private void onItemSelected(STBuyProductLog log) {
		...
		parentActivity.pushNewActivityAnimated(ZiYouKeHuShangPinDingGouXiangXiActivity.class, bundle, ZiYouKeHuShangPinDingGouActivity.REQCODE_COMPLETED_DETAIL);
	}
