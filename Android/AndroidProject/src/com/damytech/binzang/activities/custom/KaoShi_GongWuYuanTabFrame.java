 ...
 */
public class KaoShi_GongWuYuanTabFrame extends SuperTabActivity.TabFrame {
	private ImageView imgGongHuYuan = null;

	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		super.onCreateView(inflater, container, savedInstanceState);

		View contentView = inflater.inflate(R.layout.activity_kaoshi_gongwuyuan_tab, container, false);
	...
	private void initControls(View parentView) {
		imgGongHuYuan = (ImageView)parentView.findViewById(R.id.img_gonghuyuan);
		loadData();
	}
	...
	private void setGongWuYuanUrl(String url) {
		BitmapUtility.setImageWithImageLoader(imgGongHuYuan, url, parentActivity.loader_options);
	}}
