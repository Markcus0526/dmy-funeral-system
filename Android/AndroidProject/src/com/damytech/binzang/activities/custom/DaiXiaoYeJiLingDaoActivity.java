 ...
 * Date : 2015-04-23
 * Time : 16:20
 * File Name : DaiXiaoYeJiLingDaoActivity
 */
public class DaiXiaoYeJiLingDaoActivity extends SuperActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState, R.layout.activity_daixiaoyeji_lingdao);
	}
	...
	private void getPagedItems() {
		...
		CommManager.getAgentPersonalScore(AppCommon.loadUserIDLong(getApplicationContext()),
				page_no,
				scores_delegate);
	}
	...
	private CommDelegate scores_delegate = new CommDelegate() {
		...
		public void getAgentPersonalScoreResult(int retcode, String retmsg, ArrayList<STPersonalScore_Boss> arrScores) {
			super.getAgentPersonalScoreResult(retcode, retmsg, arrScores);
			stopProgress();
			...
			if (retcode == CommErrMgr.ERRCODE_NONE) {
				...
				ToastUtility.showToast(DaiXiaoYeJiLingDaoActivity.this, retmsg);
			}
		}
	};
