 ...
 */
public class DingJinDanChaXunYuanGongActivity_TabFrame2 extends SuperTabActivity.TabFrame {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View contentView = inflater.inflate(R.layout.activity_dingjindanchaxun_yuangong_tab2, container, false);
	...
	private void getItemsFromService() {
		...
		CommManager.getAgentDepositLogs(AppCommon.loadUserIDLong(parentActivity.getApplicationContext()),
	...
	private CommDelegate list_delegate = new CommDelegate() {
		...
		public void getAgentDepositLogsResult(int retcode, String retmsg, ArrayList<STDepositLog> arrLogs) {
			super.getAgentDepositLogsResult(retcode, retmsg, arrLogs);
			stopProgress();
