...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		Drawable arrowD = getResources().getDrawable(R.drawable.preset_pull_to_refresh_indicator_arrow);
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				setBackgroundResource(R.drawable.preset_pull_to_refresh_indicator_bg_bottom);
			...
			case PULL_FROM_START:
				...
				setBackgroundResource(R.drawable.preset_pull_to_refresh_indicator_bg_top);
				break;
		}
