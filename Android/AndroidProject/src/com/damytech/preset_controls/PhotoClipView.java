...
/**
 * Created by KimHM on 2014/10/20.
 */
public class PhotoClipView extends View {
	...
	public PhotoClipView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public PhotoClipView(Context context, AttributeSet attrs, int defStyle) {
