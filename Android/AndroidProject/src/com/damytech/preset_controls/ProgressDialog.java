...
public class ProgressDialog extends Dialog {
	...
	{
		message = parentContext.getResources().getString(R.string.please_wait);
		progress_mode = MODE_WAITER;
	}

	private void initResolution()
	{
		Point ptScreen = ResolutionUtility.getScreenSize(parentContext.getApplicationContext());
		ResolutionUtility.instance.iterateChild(((RelativeLayout)findViewById(R.id.parent_layout)).getChildAt(0), ptScreen.x, ptScreen.y);
