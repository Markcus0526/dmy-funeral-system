...
package com.damytech.preset_controls.WheelPicker;
...
public class WheelView extends View {
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.preset_wheel_val);
		}
		...
		setBackgroundResource(R.drawable.preset_wheel_bg);
	}
	...
	private int getMaxTextLength() {
		...
		for (int i = Math.max(currentItem - addItems, 0);
			 i < Math.min(currentItem + visibleItems, adapter.getItemsCount());
			 i++)
		{
