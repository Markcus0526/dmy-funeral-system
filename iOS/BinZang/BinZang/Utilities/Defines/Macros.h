...
// View Controller - Anim Transition
...
#define TEST_NETWORK_RETURN if ([GlobalFunc hasNetworkConnectivity] == NO) { \
								[SVProgressHUD dismissWithError:@"没有网络连接"]; \
								return; \
							}

#define BACKGROUND_TEST_NETWORK_RETURN    if ([GlobalFunc hasNetworkConnectivity] == NO) { \
											return; \
										}
...
#define showToastWithDelay(msg,delay)						[self.view makeToast:msg duration:delay position:@"center"];
