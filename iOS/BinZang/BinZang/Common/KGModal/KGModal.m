...
NSString *const KGModalViewTapped = @"KGModalViewTapped";

@interface KGModalGradientView : UIView
@end

@interface KGModalContainerView : UIView
@property (nonatomic) int nSelelectedIndex;
@end
 ...
 nSelIndex: (int) nSelIndex
{
    ...
    containerView.nSelelectedIndex = nSelIndex;
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    NSDictionary* dict = [NSDictionary dictionaryWithObject:
                          [NSNumber numberWithInt:self.nSelelectedIndex]
                                                     forKey:@"index"];
    [[NSNotificationCenter defaultCenter] postNotificationName:KGModalViewTapped   object:self
                                                      userInfo:dict];
