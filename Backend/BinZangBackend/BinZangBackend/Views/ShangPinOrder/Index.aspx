    ...
    initTable1 = function () {
          ...
          oTable = table.dataTable({
                ...
                "language": {
                 ...
                 "sServerMethod": "POST", 
                "sAjaxSource": url+"ShangPinOrder/GetJBOrder",
                "aoColumns": [
                      ...
                      "fnServerData": function(sSource, aoData, fnCallback){
				        ...
				        },
				        {
				           ...
				           if (row.status==0)
				           {
                        return '<a onclick="ViewInfo('+data+')">商品订单</a> &nbsp;'+' <a onclick="DelJibai('+data+')">取消</a>';
				           }
                            if (row.status==1)
				           {
     ...
     function SearchJiBai(){

                     oTable.fnDestroy();
                      initTable1();
       }

                   function DelJibai(uid){
                   // alert(uid);
                      var rootUri ="<%= ViewData["rootUri"] %>";
                         $.ajax({

                            url: rootUri + "ShangPinOrder/DelJiBai",
                            data: {
                                "sid": uid
      ...
      function ExportZiJiBai(){
           ...
           var clientname = $('#name').val();
            ...
            location.href= rootUri + "ShangPinOrder/ExportZiJi?cname="+clientname+"&&phone="+clientphone+"&&stime="+stime+"&&etime="+etime+"&status="+status;
