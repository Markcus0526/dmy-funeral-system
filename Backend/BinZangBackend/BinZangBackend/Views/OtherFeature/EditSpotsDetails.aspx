				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze" style=" margin-top:2%">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa  fa-university"></i>修改景点
							</div>
                      ...
                      <table style="width:580px; height:400px; margin-left:50px;">
                         ...
                         <td rowspan="2" style="width:220px;">
                           图片:
                            ...
                            <div id="advertCarImg" class="form-group" style="width:160px; border:2px solid #BBB;">
                                <img src="<%= ViewData["rootUri"] %><%= ViewData["imgurl"] %>" id ="picture" height="150px" width="156px"/>	
                                <input type="hidden" id="img" class="img"  name="img" value="<%= ViewData["imgurl"] %>" />
                                </div>
                            </div>   
                         ...
                         &nbsp;<input id="name" style="width:180px; height:30px;" value="<%= ViewData["name"] %>"/>
                         &nbsp;<input id="id" style="width:180px; height:30px; display:none" value="<%= ViewData["id"] %>"/>
                         </td>
                         </tr>
                          <tr>
                         <td  align="left" style="width:80px;">
                         ...
                         <td style="width:200px;">&nbsp;<input id="phone" style="width:180px;height:30px;" value="<%= ViewData["phone"] %>"/></td>
                         </tr>
                          <tr>
        ...
        var orgAddr = "沈阳";
          // $("#address").val(orgAddr);
            if (orgAddr != null && orgAddr != "") {
                var orglng = "<%= ViewData["lng"] %>";
                var orglat = "<%= ViewData["lat"] %>";
    ...
    jQuery(function ($) {
     ...
     $(document).ready(function() {
           ...
           function editscenic(){
            ...
            var lat=$("#lat").val();
              var phone=$("#phone").val();
              var contents=escape($("#contents").val());
              var id=$("#id").val();
                $.ajax({
                    type: "POST",
                    method: 'post',
                    url: "<%= ViewData["rootUri"] %>OtherFeature/EditScenicSpots",
                    data:{"img":img,"name":name,"address":address,"phone":phone,"contents":contents,"id":id, "lng":lng, "lat":lat},
