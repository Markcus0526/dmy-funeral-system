                            ...
                            <table cellpadding="0" style="margin-top:20px;" cellspacing="0"width="93%" class="editDlg" class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
                                                ...
                                                <tr>
                                                    <td>
                                                         <div class="form-group" style="margin-left:10px">
                                                            <div class="clearfix">                                               	  
                                                          <input id="cname" type="text" class="cname" name="cname"/>
                                                          </div>
                                                         </div>
                                                    </td>
                                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     <div class="form-group" style="margin-left:10px">
                                        <div class="clearfix"> 
                                           <input id="price" name="price" type="text" style="width:100px"  />元 
                                           </div>
                                      </div> 
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                     <div class="form-group" style="margin-left:10px">
                                        <div class="clearfix"> 
                                           <input id="approve" name="approve" type="text" placeholder="请输入小于100的认同度" /> 
                                           </div>
                                      </div> 
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <div class="form-group" style="margin-left:10px">
                                       <div class="clearfix"> 
                                        <select class="select2" style="width:40%" id="chengshi"  name="chhengshi" onchange="setarea(this.value)">
                                           <%
                                ...
                                <tr>
                                    ...
                                    <div class="form-group" style="margin-left:10px;margin-top:10px">
                                       <div class="clearfix"> 
                                       <textarea id="contents" class="contents"  name="contents" style="width:350px;height:100px;" rows="8"></textarea>
                                    </div>
                                    </div> 
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <div class="form-group" style="margin-left:10px">
                                        <div class="clearfix"> 
                                       <textarea id="cdetail" class="cdetail"  name="cdetail" style="width:350px;height:100px;" rows="8"></textarea>
                                    </div>
                                    </div> 
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <div class="form-group" style="margin-top:0px;margin-left:10px">
                                     <div class="clearfix"> 
                                      <textarea id="productdetail" class="productdetail"  name="productdetail" style="width:350px;height:200px;" rows="8"></textarea>
            ...
            $('#validation-form').validate({
	            ...
	            rules: {
                    ...
                    lat: {
                      required: true,
                      remote:{
                                url: rootUri+"ZoneInformation/GetADrgonSamePoint",    //后台处理程序 
                              type: "post",              //数据发送方式
      ...
      function check4(){
       ...
       function check3(){
        ...
        if(check1()==true&&check2()==true&&check3()==true&&check4()==true)
        {
			$.ajax({
				type: "POST",
				url: "<%= ViewData["rootUri"] %>ZoneInformation/InserADragon",
				dataType: "json",
