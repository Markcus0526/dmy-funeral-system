                    ...
                    <div class="searchbar" >
                        <form class="form-horizontal" role="form" id="validation-form" >
                            ...
                            <div class="form-group">
                                ...
                                <label class="col-sm-1 control-label no-padding-right" style="margin-left:0px" for="">地区</label>
                      ...
                      <select class="select2" style="width:40%" id="area"  name="area">
                                    ...
                                    <label class="col-sm-2 control-label no-padding-right"  style="margin-left:50px" for="">办事出名称</label>
				                    <div class="col-sm-1" style="margin-left:-10px">
                                        <div class="clearfix" style="width:150px">
                                      
                                    <input  id="officename" value="" style="height:28px;margin-top:1px" placeholder="请输入关键字"/>
                                        </div>
				                    </div>    
                                ...
                                <div class="col-sm-1" style="margin-left:20px"">
						                <a class="btn  btn-success" href="<%=ViewData["rootUri"] %>ZoneInformation/AddOffice"><i class="fa fa-plus"></i> 增加</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-building-o"></i>办事处管理
							</div>
...
var initTable1;
    jQuery(document).ready(function () {
        ...
        initTable1 = function () {
            ...
            oTable = table.dataTable({
                //"bServerSide": true,
			    "bProcessing": true,
			    "sAjaxSource": rootUri + "ZoneInformation/SerchOffice/?area="+$("#area").val()+"&officename="+$("#officename").val(),
                "language": {
                    "aria": {
                ...
                "aoColumns": [
                     ...
                     {"mDataProp": "chengshi","bSortable": false },
            ...
            "columnDefs": [
				        ...
				        },
				        {
				            ...
				            "render": function(data, type, row) {   // o, v contains the object and value for the column
				                var rst = '<br/><br/><a  href="' + rootUri + 'ZoneInformation/SeeOffice/?makeid=1&uid=' + data + '" style="font-size:13px">' +
                                    '查看</a>&nbsp;&nbsp;';
				                rst += '<a href="' + rootUri + 'ZoneInformation/SeeOffice/?makeid=2&uid=' + data + '" style="font-size:13px">' +
                                    '修改</a>&nbsp;&nbsp;';
     ...
     function DelNotice(uid)
   {
     ...
     if(conf==true)
     {
        $.ajax({
                    type: "POST",
                    url: rootUri + "ZoneInformation/DelOffice",
                    dataType: "json",
                    data: {
