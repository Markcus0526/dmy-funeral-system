                    ...
                    <div class="searchbar" >
                        <form class="form-horizontal" role="form" id="validation-form" >
                            ...
                            <div class="form-group" > 
                                 <label class="col-sm-2 control-label no-padding-right"  style="margin-left:5px" for="">通知名称</label>
				                    <div class="col-sm-1" style="margin-left:-10px">
                                        <div class="clearfix" style="width:150px">
                                      
                                    <input  id="acyivityname" value="" style="height:28px;margin-top:1px" placeholder="请输入名称关键字"/>
                                        </div>
				                    </div>    
                                ...
                                <div class="col-sm-1" style="margin-left:20px"">
						                <a class="btn  btn-success" href="<%=ViewData["rootUri"] %>ZoneInformation/AddActivity"><i class="fa fa-plus"></i> 增加</a>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-volume-down"></i>园区活动管理
							</div>
...
var initTable1 = function () {
            ...
            oTable = table.dataTable({
                ...
                //"bServerSide": true,
			    "bProcessing": true,
			    "sAjaxSource": rootUri + "ZoneInformation/SerchActivity/?activityname="+$("#acyivityname").val(),
                "language": {
                    "aria": {
                ...
                "aoColumns": [
					 {"mDataProp": "activityurl","bSortable": false },	
                     {"mDataProp": "activityname","bSortable": false },
               ...
               "columnDefs": [
				        ...
				        },
				        {
				            ...
				            "render": function(data, type, row) {   // o, v contains the object and value for the column
				                var rst = '<br/><br/><a  href="' + rootUri + 'ZoneInformation/SeeActivity/?makeid=1&uid=' + data + '" style="font-size:13px">' +
                                    '查看</a>&nbsp;&nbsp;';
				                rst += '<a href="' + rootUri + 'ZoneInformation/SeeActivity/?makeid=2&uid=' + data + '" style="font-size:13px">' +
                                    '修改</a>&nbsp;&nbsp;';
                                rst += '<a href="#" onclick="DelActivity(' + data + ')" style="font-size:13px">' +
                                    '删除</a>';
				                return rst;
				            }
				            //sClass: 'center'
    ...
    function DelActivity(uid)
   {
     ...
     if(conf==true)
     {
        $.ajax({
                    type: "POST",
                    url: rootUri + "ZoneInformation/DelActivity",
                    dataType: "json",
                    data: {
