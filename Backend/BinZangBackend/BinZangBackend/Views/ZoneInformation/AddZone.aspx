                            ...
                            <table cellpadding="0" style="margin-top:20px;" cellspacing="0"width="93%" class="editDlg" class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
                                            ...
                                            <table cellpadding=0 cellspacing=0 width="100%">
                                                <tr>
                                                    <td>
                                                         ...
                                                         <div class="clearfix">                                             	  
                                                          <input id="zonename" type="text" class="zonename" name="zonename"/>
                                                          </div>
                                                         </div>
                                                    </td>
                                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     <div class="form-group" style="margin-left:10px">
                                     <div class="clearfix">
                                          <select class="select2" style="width:40%" id="zonetype"  name="zonetype" onchange="seyquyu(this.value)">
                                ...
                                <tr id="quyu" style="display:none">
                                             ...
                                             <tr>
                                                <td>
                                                    <div class="form-group" style="margin-left:10px;margin-top:5px">
                                                     <div class="clearfix">
                                                           <input type="text" name="quyuname" style="width:120px"/>
                                                      </div>
                                                     </div>
                                                </td>
                                                <td>
                                                <div class="form-group" style="margin-left:10px;margin-top:5px">
                                                     <div class="clearfix">
                                                           <input type="text" name="pwpaishu" style="width:120px"/>
                                                      </div>
                                                     </div>
                                                </td>
                                               ...
                                               <div class="form-group" style="margin-left:10px;margin-top:5px">
                                                     <div class="clearfix">
                                                           <input type="text" name="pwlieshu" style="width:120px"/>
                                                      </div>
                                                     </div>
                                                </td>
                                 ...
                                 <tr id="mudipaishu">
                                    ...
                                    <td>
                                     <div class="form-group" style="margin-left:10px">
                                     <div class="clearfix">
                                           <input id="paishu" type="text" class="paishu" name="paishu"/>
                                      </div>
                                     </div>
                                    </td>
                                </tr>
                                <tr id="mudilieshu">
                                    ...
                                    <div class="form-group" style="margin-left:10px">
                                    <div class="clearfix">
                                        <input id="lieshu" type="text" class="lieshu" name="lieshu"  /> 
                                        </div> 
                                    </div> 
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <div class="form-group" style="margin-left:10px">
                                    <div class="clearfix">
                                         <textarea id="contents" name="contents" style="width:400px;height:200px; resize:none;" rows="8"></textarea>
                                        </div>
                                    </div> 
                                    </td>
                                </tr>
                                        ...
                                        <div class="clearfix" style="">
                                         ...
                                         <div class="configurator" id="searchBox" >
                                            ...
                                            <div style="margin-top:10px">
                                             <input id="xpos" readonly type="text" class="xpos" name="xpos"  /> 
                                             <input id="ypos" readonly type="text" class="ypos" name="ypos"  /> 
                                            </div>
                                       </div>
...
var div_orgyy=div_orgY;
     function Addpw() {
       ...
       // onMarkObjDestroy(0);
        ...
        $("#xpos").val(xPos);
        $("#ypos").val(yPos);
    onMarkObjCreate(0, "", xPos,yPos, true);
     ...
     function seyquyu(id)
    {
      if(id==1)
      {
        ...
        $("#mudipaishu").hide();
        $("#mudilieshu").hide();
        $("#disWidth").val("<%=ViewData["disWidth"] %>");
        $("#disHeight").val("<%=ViewData["disHeight"] %>");
        $("#disRatio").val("<%=ViewData["disRatio"] %>");
        $("#zoneimg").attr("src", "<%=ViewData["rootUri"] %>Content/img/qimg.jpg");
    ...
    function check1(){
      ...
      if(id==0)
      {
        ...
        if(check1()==true&&check3($("#zonetype").val())==true)
        {
			$.ajax({
				type: "POST",
				url: "<%= ViewData["rootUri"] %>ZoneInformation/InserZone/?quyushu="+quyushu,
				dataType: "json",
