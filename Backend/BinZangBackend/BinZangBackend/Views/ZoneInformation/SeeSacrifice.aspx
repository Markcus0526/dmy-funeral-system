...
<div style="width:700px;margin-left:200px;border:1px solid #CCC;margin-top:20px">
                            ...
                            <table cellpadding="0" style="margin-top:20px;height:750px" cellspacing="0"width="93%" class="editDlg" class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
                                            ...
                                            <table cellpadding=0 cellspacing=0 width="100%">
                                                <tr>
                                                    <td>
                                                         ...
                                                         <div class="clearfix">                                                	  
                                                          <input id="pname" <%if( Convert.ToInt32(ViewData["makeid"])==1) {%> readonly<%} %> type="text" value="<%= ViewBag.sacrifice.name %>" class="pname" name="pname"/>
                                                          <div class="clearfix">  
                                                         </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="form-group" style="margin-left:10px">
                                                        <div id="advertCarImg" class="form-group" style="width:160px; border:2px solid #BBB;">
                                                         <img src="<%=ViewData["rootUri"] %><%=ViewBag.sacrifice.imgurl %>" id = "picture" height="150px" width="156px"/>	
                                                         <input type="hidden" id="img" class="img"  name="img" value="<% if (ViewBag.sacrifice.imgurl != null) { %><%= ViewBag.sacrifice.imgurl %><% } %>" />
                                                         </div>
                                                      </div>
                                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     <div class="form-group" style="margin-left:10px">
                                     <div class="clearfix">  
                                           <input type="text" <%if( Convert.ToInt32(ViewData["makeid"])==1) {%> readonly<%} %> id="price" value="<%= ViewBag.sacrifice.price %>" name="price" style="width:100px"/>元 
                                     <div class="clearfix">  
                                      </div> 
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                    <div class="form-group" style="margin-left:10px">
                                        <select class="select2" <%if( Convert.ToInt32(ViewData["makeid"])==1) {%> disabled=disabled<%} %> id="ptype" name="ptype" style="width:150px" onchange="set(this.value)">
                                ...
                                <tr>
                                    ...
                                    <div class="form-group" style="margin-left:10px">
                                        ...
                                        <select class="select2" <%if( Convert.ToInt32(ViewData["makeid"])==1) {%> disabled=disabled <%} %> id="fahuiactivity" style="width:150px;display:none" >
                                            <%
                                ...
                                <tr>
                                    ...
                                    <div class="clearfix">  
                                      <textarea id="pdetail" <%if( Convert.ToInt32(ViewData["makeid"])==1) {%> readonly<%} %> class="pdetail"   name="pdetail" style="width:350px;height:200px;" rows="8"><%= ViewBag.sacrifice.description%></textarea>
                                   </div>
                                   </div>
                                   </td>
                                </tr>
                            ...
                            &nbsp;
                                       <button id="sett" class="btn" type="reset" onclick="return resetset()"  style="margin-top:10px;margin-left:10px">
...
var ptype="<%=ViewBag.sacrifice.type %>";
var fahuiid="<%=ViewData["fahuiid"] %>";
$("#ptype option[value='"+ptype+"']").attr("selected", "selected");
function resetset()
{
   $("#ptype option[value='"+ptype+"']").attr("selected", "selected");
   $("#ptype").css('width', '150px').select2({ minimumResultsForSearch: -1 });
   set(ptype);
} 
 ...
 if(ptype==4)
{
  ...
  $("#fahuiactivity option[value='"+fahuiid+"']").attr("selected", "selected");
  $("#fahuiactivity").css('width', '150px').select2({ minimumResultsForSearch: -1 });
  set(4);
}
...
//      }
        ...
        if(check1()==true&&check2()==true&&check3($("#ptype").val())==true)
        {
			$.ajax({
				type: "POST",
				url: "<%= ViewData["rootUri"] %>ZoneInformation/UpdateSacrifice/?fahuiactivity="+$("#fahuiactivity").val()+"&uid=<%= ViewBag.sacrifice.uid %>",
				dataType: "json",
