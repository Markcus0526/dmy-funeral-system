                    ...
                    <div class="searchbar" >
                        <form class="form-horizontal" role="form" id="validation-form" >
                            ...
                            <div class="form-group" >
                                <label class="col-sm-1 control-label no-padding-right" style="margin-left:0px" for="">商品种类</label>
				                <div class="col-sm-1" style="margin-left:-10px">
                                    <div class="clearfix" style="width:150px">
                                  <select class="select2" id="ptype" style="width:150px">
                                ...
                                <label class="col-sm-1 control-label no-padding-right" style="margin-left:90px" for="">商品价格</label>
				                <div class="col-sm-1" style="margin-left:-10px">
                                    <div class="clearfix" style="width:150px">

                                      <select class="select2" id="price" style="width:150px" >
                                            <option value="0" >不限</option> 
                                            <option value="0,50" >50元以下</option>
                                            <option value="50,100" >50元-100元</option>
                                            <option value="100,300" >100元-300元</option>
                                            <option value="300,500" >300元-500元</option>
                                            <option value="500" >500元以上</option>           
                                            </select>
                      
                                    </div>
				                </div> 
                                 <label class="col-sm-2 control-label no-padding-right"  style="margin-left:30px" for="">商品名称</label>
				                    <div class="col-sm-1" style="margin-left:-10px">
                                        <div class="clearfix" style="width:150px">
                                      
                                    <input  id="pname" value="" style="height:28px;margin-top:1px" placeholder="请输入商品关键字"/>
                                        </div>
				                    </div>    
                                ...
                                <div class="col-sm-1" style="margin-left:20px"">
						                <a class="btn  btn-success" href="<%=ViewData["rootUri"] %>ZoneInformation/AddSacrifice"><i class="fa fa-plus"></i> 增加</a>
...
var initTable1;
    jQuery(document).ready(function () {
        ...
        initTable1 = function () {
            ...
            oTable = table.dataTable({
			    ...
			    "bProcessing": true,
                //"aaSorting" : [[4, "desc"]],
			    "sAjaxSource":  rootUri + "ZoneInformation/SerchSacrifice",
                "language": {
                    "aria": {
                ...
                "aoColumns": [
					 {"mDataProp": "pname","bSortable": false },	
                     {"mDataProp": "price","bSortable": false },
                     {"mDataProp": "ptype","bSortable": false },
                ...
                "fnServerData": function(sSource, aoData, fnCallback){
                                      $.ajax({
                                          ...
                                          "type": "POST",
                                          "url": sSource,
                                          "data":{"pname":$("#pname").val(), "ptype":$("#ptype").val(),"price":$("#price").val()} ,
                                           "success": fnCallback
                                     });
                      },
                "order": [
            ...
            "columnDefs": [
				        ...
				        },
				        {
				            ...
				            "render": function(data, type, row) {   // o, v contains the object and value for the column
				                var rst = '<br/><br/><a  href="' + rootUri + 'ZoneInformation/SeeSacrifice/?makeid=1&uid=' + data + '" style="font-size:13px">' +
                                    '查看</a>&nbsp;&nbsp;';
				                rst += '<a href="' + rootUri + 'ZoneInformation/SeeSacrifice/?makeid=2&uid=' + data + '" style="font-size:13px">' +
                                    '修改</a>&nbsp;&nbsp;';
     ...
     function DelNotice(uid)
   {
     ...
     if(conf==true)
     {
        $.ajax({
                    type: "POST",
                    url: rootUri + "ZoneInformation/DelSacrifice",
                    dataType: "json",
                    data: {
