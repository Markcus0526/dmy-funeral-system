				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze" style=" margin-top:2%">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa  fa-university"></i>修改员工
							</div>
                      ...
                      <table style="width:780px; height:500px; margin-left:50px;">
                        ...
                        <tr>
                         ...
                         <td style="width:200px;">&nbsp;
                         <input id="duty" onblur="check5(this.value)" style="width:180px;height:30px;"/>
                            </td>
                          <td style="width:200px;">
...
<script>
     ...
     if(value.length>50){
      ...
      function check5(value){
       var isNum = /^[0-9]*$/;
       if($("#duty").val().length>50){
        document.getElementById("Text5").style.display="block";
        $('#Text5').val("输入的字数不能多于50字");
        flag5 =false;
        }else  if($("#duty").val().length<=0){
        document.getElementById("Text5").style.display="block";
        $('#Text5').val("输入不能为空");
        flag5 =false;
        }else if (!isNum.test($("#duty").val()))
        {
       document.getElementById("Text5").style.display="block";
        $('#Text5').val("输入的数据不正确,应输入整数");
        flag5 =false;
        }else{
    ...
    jQuery(function ($) {  
           ...
           $("#img").val("<%= ViewData["img"]%>");
                    ...
                    $("#duty").val("<%= ViewData["duty"]%>");
                    $("#banshichu").val("<%= ViewData["office"]%>");
     ...
     $(document).ready(function() {
          ...
          function addscenic(){
          var img=$("#img").val();
            if (img!=""&&img!=null&&flag1==true&&flag2==true&&flag5==true&&flag6==true)
            {
              ...
              var phone=$("#phone").val();
              var duty=$("#duty").val();
              var office=$("#banshichu").val();
            $.ajax({
                url: "<%= ViewData["rootUri"] %>ManagePerson/EditStaffInfo",
                data:{
                "id":"<%= ViewData["id"] %>",
                "img":img,
                "name":name,
                ...
                success: function (data) {
                 ...
                 toas1("添加成功");
                 setTimeout(function(){
                 location.href="<%= ViewData["rootUri"] %>ManagePerson/Staff";
                 },3000);
