...
<div class="row" style=" width:auto; min-width:980px;">
				...
				<div>
                        ...
                        主任姓名：</label><input style=" width:120px;height:28px" id="name"/>
                        ...
                        <label style=" margin-left:2%">
                        主任类型：</label><select class="select2" style=" width:30px" id="type">
                        <option value="0">全部</option>
					...
					<div class="portlet box green-haze" style=" margin-top:2%">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa  fa-university"></i>办事处主任
							</div>
							<div class="tools" style=" margin-top:-15px;">
                             <Button id="Button1" class="btn btn-success loading-btn" onclick="addlingdao()" style="margin-top:10px;margin-left:10px">
  ...
  var initTable1;
    jQuery(document).ready(function () {
        //QuickSidebar.init(); // init quick sidebar
          ...
          oTable = table.dataTable({
                ...
                "bServerSide": false,
                "sServerMethod": "POST", 
                "sAjaxSource": "<%= ViewData["rootUri"] %>ManagePerson/FindAllZhuRen",
                "aoColumns": [
                        {"mDataProp": "name","bSortable": false },	
					    {"mDataProp": "types","bSortable": false },	
                ...
                "columnDefs": [
				      
				        {
				            ...
				            "render": function(data, type, row) {   // o, v contains the object and value for the column
				                   return '<a href="<%=ViewData["rootUri"] %>ManagePerson/FindBanShiChuZhuRen?id='+data+'">查看详情</a> &nbsp;    <a  data-toggle="modal" href="<%=ViewData["rootUri"] %>ManagePerson/EditBanShiChuZhuRen?id='+data+'" >修改</a>&nbsp; <a href="javascript:deletedspots('+data+')">删除</a>';
                            },
				            sClass: 'center'
				        }
                    ],
   ...
   jQuery(function ($) {  
      ...
      jQuery(function ($) {
       ...
       function addlingdao(){
       location.href="<%=ViewData["rootUri"] %>ManagePerson/AddBanShiChuZhuRen";
       }
       function deletedspots(id){
       var gnl=confirm("你真的确定要删除吗?");
            if (gnl==true){
             $.ajax({
                    url: "<%= ViewData["rootUri"] %>ManagePerson/DeletedDaBanShiChuZhuRen",
                    data:{"id":id},
