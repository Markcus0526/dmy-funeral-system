					...
					<div class="portlet box green-haze" style=" margin-top:2%">
                      ...
                      <table style="width:780px; height:500px; margin-left:50px;">
                        ...
                        <tr>
                         ...
                         <td style="width:200px;">&nbsp;
                         <select class="select2 " onkeyup="check5(this.value)"  style=" width:180px"   id="owner_name">
    ...
    jQuery(function ($) {  
     ...
     $(document).ready(function() {
          ...
          function addscenic(){
            ...
            $.ajax({
                url: "<%= ViewData["rootUri"] %>ManagePerson/EditDaiXiaoShangInfo",
                data:{
                "id":"<%= ViewData["id"] %>",
                "img":img,
                "name":name,
                ...
                success: function (data) {
                 ...
                 toas1("添加成功");
                 setTimeout(function(){
                 location.href="<%= ViewData["rootUri"] %>ManagePerson/DaiXiaoShang";
                 },3000);
           ...
           function findone(){
              $.ajax({
                url: "<%= ViewData["rootUri"] %>ManagePerson/FindOneById",
                data:{"id":"<%= ViewData["id"] %>" },
                success: function (data) {
                    $("#img").val(data.imgurl);
                    $("#name").val(data.name);
                    ...
                    $("#owner_name").val(data.owner_id);
                    $("#banshichu").val(data.office_id);
