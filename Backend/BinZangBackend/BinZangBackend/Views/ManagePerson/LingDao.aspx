...
<div class="row" style=" width:auto; min-width:980px;">
				...
				<div>
                        ...
                        领导姓名：</label><input style=" width:150px;height:28px" id="name"/>
                        <label style=" margin-left:2%">
                        电话号码：</label><input  style="width:150px;height:28px" id="phone"/>
                        <label style=" margin-left:2%">
                        领导类型：</label><select class="select2" style=" width:30px" id="type">
    ...
    jQuery(document).ready(function () {
        //QuickSidebar.init(); // init quick sidebar
          ...
          oTable = table.dataTable({
                ...
                "bServerSide": false,
                "sServerMethod": "POST", 
                "sAjaxSource": "<%= ViewData["rootUri"] %>ManagePerson/FindAllLingDao",
                "aoColumns": [
                ...
                "columnDefs": [
				      
				        {
				            ...
				            "render": function(data, type, row) {   // o, v contains the object and value for the column
				                   return '<a href="<%=ViewData["rootUri"] %>ManagePerson/FindLingDao?id='+data+'">查看详情</a> &nbsp;    <a  data-toggle="modal" href="<%=ViewData["rootUri"] %>ManagePerson/EditLingDao?id='+data+'" >修改</a>&nbsp; <a href="javascript:deletedspots('+data+')">删除</a>';
                            },
				            sClass: 'center'
				        }
                    ],
   ...
   jQuery(function ($) {  
      ...
      jQuery(function ($) {
       ...
       var gnl=confirm("你真的确定要删除吗?");
            if (gnl==true){
             $.ajax({
                    url: "<%= ViewData["rootUri"] %>ManagePerson/DeletedDLingDao",
                    data:{"id":id},
      ...
      function addlingdao(){
      location.href="<%=ViewData["rootUri"] %>ManagePerson/AddLingDao";
      }
</script>
