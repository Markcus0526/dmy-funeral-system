				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze" style=" margin-top:2%">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa  fa-university"></i>修改办事处主任
							</div>
...
<script>
    ...
    jQuery(function ($) {  
     ...
     $(document).ready(function() {
          ...
          function addscenic(){
          var img=$("#img").val();
            if (img!=null&&img!=""&&flag1==true&&flag2==true&&flag5 ==true&flag6==true)
            {
              var name=$("#name").val();
              ...
              var weixin=$("#weixin").val();
               ...
               var duty=$("#duty").val();
            $.ajax({
                url: "<%= ViewData["rootUri"] %>ManagePerson/EditBanShiChuZhuRenInfo",
                data:{
                "id":"<%= ViewData["id"] %>",
                "img":img,
                "name":name,
