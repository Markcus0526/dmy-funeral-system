...
<div class="row" style=" width:auto; min-width:980px;">
				<div class="col-md-12">
				<div>
                                   <div style=" height:80px; margin-top:4%; width:auto; min-width:980px; border:1px solid #3B9C96">
                        <div style="margin-top:1%; margin-left:1%">
                        <label style=" font-size; small">
                        员工姓名：</label><input style=" width:150px;height:28px" id="name"/>
                        <label style=" margin-left:2%">
                        电话号码：</label><input  style="width:150px;height:28px" id="phone"/>
                        <label style=" margin-left:2%">
                        所在办事处：</label><select class="select2" style=" width:30px" id="banshichu">
					...
					<div class="portlet box green-haze" style=" margin-top:2%">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa  fa-university"></i>员工
							</div>
							<div class="tools" style=" margin-top:-15px;">
                               <Button id="Button1" class="btn btn-success btn-sm" onclick="addstaff()" style="margin-top:10px;margin-left:10px">
    ...
    jQuery(document).ready(function () {
        //QuickSidebar.init(); // init quick sidebar
          ...
          oTable = table.dataTable({
                ...
                "bServerSide": false,
                "sServerMethod": "POST", 
                "sAjaxSource": "<%= ViewData["rootUri"] %>ManagePerson/FindAllStaff",
                "aoColumns": [
                ...
                "columnDefs": [
				      
				        {
				            ...
				            "render": function(data, type, row) {   // o, v contains the object and value for the column
				                   return '<a href="<%=ViewData["rootUri"] %>ManagePerson/FindStaff?id='+data+'">查看详情</a> &nbsp;    <a  data-toggle="modal" href="<%=ViewData["rootUri"] %>ManagePerson/EditStaff?id='+data+'" >修改</a>&nbsp; <a href="javascript:deletedspots('+data+')">删除</a>';
                            },
				            sClass: 'center'
				        }
                    ],
   ...
   jQuery(function ($) {  
      ...
      jQuery(function ($) {
       ...
       var gnl=confirm("你真的确定要删除吗?");
            if (gnl==true){
             $.ajax({
                    url: "<%= ViewData["rootUri"] %>ManagePerson/DeletedStaff",
                    data:{"id":id},
       ...
       function addstaff(){
       location.href ="<%=ViewData["rootUri"] %>ManagePerson/AddStaff";
       }
