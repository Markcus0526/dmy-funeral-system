				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze" style=" margin-top:2%">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa  fa-university"></i>添加后台用户
							</div>
                      ...
                      <table style="width:780px; height:300px; margin-left:50px;">
                        ...
                        <tr>
                         ...
                         <td style="width:200px;">&nbsp;<input id="password" name="password" onblur="check7(this.value)" style="width:180px;height:30px;"/></td>
                           <td style="width:200px;">
    ...
    jQuery(function ($) {  
     ...
     $(document).ready(function() {
          ...
          if (flag1==true&&flag2==true&&flag6==true&&flag7==true)
            {
            $.ajax({
                url: "<%= ViewData["rootUri"] %>ManagePerson/AddHouTaiYouHuInfo",
                 dataType: "json",
