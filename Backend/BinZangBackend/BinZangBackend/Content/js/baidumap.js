function baidu_map(data) {
    ...
    if (data) {
        ...
        var infoWindow = new BMap.InfoWindow("这是原本位置 ,移动红点修改位置!你也可以直接修改上方位置系统自动定位!", opts);  // 创建信息窗口对象
    ...
    function doit(point) {
        ...
        if (point) {
            ...
            marker2.addEventListener("dragend", function (e) {
                ...
                myGeo.getLocation(new BMap.Point(e.point.lng, e.point.lat), function (result) {
                    if (result) {
                        ...
                        marker2.point.lat = cp.lat;
                        marker2.point.lng = cp.lng;
            ...
            map.addEventListener("dragging", function showInfo() {
                ...
                map.centerAndZoom(marker2.point, map.getZoom());
    ...
    function loadmap() {
        ...
        myGeo.getPoint(city, function (point) {
            if (point) {
                ...
                marker2.point.lat = point.lat;
                marker2.point.lng = point.lng;
                ...
                map.panTo(new BMap.Point(marker2.point.lng, marker2.point.lat));
                map.centerAndZoom(marker2.point, map.getZoom());
            }
        }); //({},province)
